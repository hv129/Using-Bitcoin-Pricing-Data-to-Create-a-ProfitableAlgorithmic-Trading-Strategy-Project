...
def predict():
    if request.method== 'POST':
        ...
        #return render_template('result.html', res=res, trainScore=trainScore, plot_url=plot_url)
        return render_template('result.html', res=res, len=len(res), n=n)
        #return render_template('result.html', date=date, n=n)
